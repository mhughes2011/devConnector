...
router.delete('/comment/:id/:comment_id', auth, async(req, res) => {
    try {
        ...
        // Pull out comment to delete (this will give us the comment if it exists or false)
        ...
        // Check user to make sure they can delete the comment.
        if(comment.user.toString() !== req.user.id) {
            return res.status(401).json({msg: 'Not authorized to delete comment'})
        }

        //  First, get the remove index of the comment to be deleted 
        ...
        // Send back the post with the array of comments
        res.json(post.comments);
